...
function MarineTeam:InitTechTree()
    ...
    --CommandStation upgrade
    self.techTree:AddResearchNode(kTechId.AdvancedWelding, kTechId.CommandStation)
    ...
    self.techTree:AddResearchNode(kTechId.AntiStompJetpackTech,        kTechId.JetpackTech)
