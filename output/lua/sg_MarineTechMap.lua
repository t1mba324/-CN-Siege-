kMarineTechMap =
{
        ...
        --R
                                            { kTechId.JetpackTech, 11, 5.5 },   {kTechId.AntiStompJetpackTech,12,5.5} ,      --{ kTechId.JetpackFuelTech, 12, 6.5 },   
...
kMarineLines = 
{
    ...
    --AdvancedWelding
    GetLinePositionForTechMap(kMarineTechMap, kTechId.AdvancedWelding, kTechId.CommandStation),

    --AntiStompJetpackTech
    GetLinePositionForTechMap(kMarineTechMap, kTechId.JetpackTech, kTechId.AntiStompJetpackTech),
